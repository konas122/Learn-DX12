...
class InstanceCullApp : public D3DApp
{
public:
	InstanceCullApp(HINSTANCE hInstance);
	InstanceCullApp(const InstanceCullApp& rhs) = delete;
	InstanceCullApp& operator=(const InstanceCullApp& rhs) = delete;
	~InstanceCullApp();
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE prevInstance, PSTR cmdLine, int showCmd)
{
	...
	try
	{
		InstanceCullApp theApp(hInstance);
...
InstanceCullApp::InstanceCullApp(HINSTANCE hInstance)
	: D3DApp(hInstance)
{
}

InstanceCullApp::~InstanceCullApp()
{
...
bool InstanceCullApp::Initialize()
{
...
void InstanceCullApp::Update(const GameTimer& gt)
{
	OnKeyboardInput(gt);
...
void InstanceCullApp::Draw(const GameTimer& gt)
{
...
void InstanceCullApp::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void InstanceCullApp::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void InstanceCullApp::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void InstanceCullApp::OnKeyboardInput(const GameTimer& gt)
{
...
void InstanceCullApp::AnimateMaterials(const GameTimer& gt)
{
}

void InstanceCullApp::UpdateInstanceData(const GameTimer& gt)
{
...
void InstanceCullApp::UpdateMaterialBuffer(const GameTimer& gt)
{
...
void InstanceCullApp::UpdateMainPassCB(const GameTimer& gt)
{
	XMMATRIX view = mCamera.GetView();
...
void InstanceCullApp::LoadTextures()
{
...
void InstanceCullApp::BuildRootSignature()
{
...
void InstanceCullApp::BuildDescriptorHeaps()
{
	// Create SRV heap
...
void InstanceCullApp::BuildShadersAndInputLayout()
{
...
void InstanceCullApp::BuildSkullGeometry()
{
...
void InstanceCullApp::BuildPSOs()
{
...
void InstanceCullApp::BuildFrameResources()
{
	for (int i = 0; i < gNumFrameResources; ++i)
	{
		mFrameResources.emplace_back(std::make_unique<FrameResource>(
			md3dDevice.Get(), 1,
			mInstanceCount, (UINT)mMaterials.size(), InitializeType::instance
		));
	}
}

void InstanceCullApp::BuildMaterials()
{
...
void InstanceCullApp::BuildRenderItems()
{
...
void InstanceCullApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 6> InstanceCullApp::GetStaticSamplers()
{
