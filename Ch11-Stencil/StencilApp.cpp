...
void StencilApp::BuildFrameResources()
{
	for (int i = 0; i < gNumFrameResources; ++i)
	{
		mFrameResources.emplace_back(std::make_unique<FrameResource>(
			md3dDevice.Get(), 2, (UINT)mAllRitems.size(), (UINT)mMaterials.size(), InitializeType::material
		));
	}
}
...
void StencilApp::BuildRenderItems()
{
	...
	mRitemLayer[(int)RenderLayer::Opaque].emplace_back(floorRitem.get());
	...
	mRitemLayer[(int)RenderLayer::Opaque].emplace_back(wallsRitem.get());
	...
	*reflectedSkullRitem = *skullRitem;
	...
	mRitemLayer[(int)RenderLayer::Reflected].emplace_back(reflectedSkullRitem.get());
	...
	*shadowedSkullRitem = *skullRitem;
	...
	mRitemLayer[(int)RenderLayer::Shadow].emplace_back(shadowedSkullRitem.get());
	...
	mRitemLayer[(int)RenderLayer::Mirrors].emplace_back(mirrorRitem.get());
	mRitemLayer[(int)RenderLayer::Transparent].emplace_back(mirrorRitem.get());

	mAllRitems.emplace_back(std::move(floorRitem));
	mAllRitems.emplace_back(std::move(wallsRitem));
	mAllRitems.emplace_back(std::move(skullRitem));
	mAllRitems.emplace_back(std::move(reflectedSkullRitem));
	mAllRitems.emplace_back(std::move(shadowedSkullRitem));
	mAllRitems.emplace_back(std::move(mirrorRitem));
}
