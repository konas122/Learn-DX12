	...
	UINT rtvDescriptorSize)
{
	...
	// The SSAO reserves heap space for 5 contiguous Srvs.
...
void Ssao::ComputeSsao(ID3D12GraphicsCommandList* cmdList, FrameResource* curFrame, int blurCount)
{
	...
	BlurAmbientMap(cmdList, curFrame, blurCount);
}
...
void Ssao::BuildRandomVectorTexture(ID3D12GraphicsCommandList* cmdList)
{
	...
	UpdateSubresources(
		cmdList, mRandomVectorMap.Get(), mRandomVectorMapUploadBuffer.Get(),
...
void Ssao::BuildOffsetVectors()
{
	...
	// This way we still get the vectors spread out
